...
const ReporteTiempoPromedioPrestamo = ({ reportData, year1, year2 }) => {
    ...
    const loansYear1 = reportData.totalPorAnio[1];
    const loansYear2 = reportData.totalPorAnio[2];
    const totalLoans = reportData.total; 
    const totalTime = reportData.tiempoTotal;
    const averageLoanTime = totalLoans ? (totalTime / totalLoans).toFixed(2) : 0;
    ...
    const data = {
        ...
        datasets: [
            {
                label: 'Préstamos por año',
                data: [loansYear1 || 0, loansYear2 || 0],
    ...
    const options = {
        ...
        plugins: {
            ...
            title: {
              display: true, 
              text: `Total de prestamos finalizados: ${reportData.total} - Años: ${year1}-${year2}  - Tiempo promedio prestamos: ${averageLoanTime} meses`,
            },
            tooltip: {
                callbacks: {
                    label: function(tooltipItem) {
                        return `Préstamos: ${tooltipItem.raw}`;
                    },
                },
            },
        },
...
export default ReporteTiempoPromedioPrestamo;
